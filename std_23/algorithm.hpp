...
namespace std {
  ...
  namespace ranges {
    ...
    template<class F, class T, class I, class U>
      concept @indirectly-binary-left-foldable-impl@ =  // \expos
        @movable@<T> && @movable@<U> &&
        @convertible_to@<T, U> && @invocable@<F&, U, iter_reference_t<I>> &&
        @assignable_from@<U&, invoke_result_t<F&, U, iter_reference_t<I>>>;

    template<class F, class T, class I>
      concept @indirectly-binary-left-foldable@ =      // \expos
    ...
    template<class F, class T, class I>
      concept @indirectly-binary-right-foldable@ =    // \expos
        @indirectly-binary-left-foldable}@<@\exposid{flipped@<F>, T, I>;
